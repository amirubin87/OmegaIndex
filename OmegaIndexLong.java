...
public class OmegaIndexLong {

	public static void main(String[] args) throws IOException {
		CalcOmegaIndex(args[0],args[1],args[2]);
		//CalcOmegaIndex("C:/cygwin/amazon.txt", "C:/cygwin/amazon-betta1.01-0.18.dat", "C:/cygwin/omegaLong.txt");
	}
    ...
    */
	...
	public static void CalcOmegaIndex(String listOfNodes1Path, String listOfNodes2Path, String outputPath) throws IOException{    
		...
		Map<Integer, long[]> amountsOfNodesWithSameAmountOfComms =  AmountOfSharedCommsToAmountOfPairsOfNodesV2(Node2Comm1,Node2Comm2, Comm2Nodes1, Comm2Nodes2, M);
		//We and Wu
		...
		Wu = ((new BigDecimal(sumUnadjustedOmegaIndex)).divide(new BigDecimal(M), 10, BigDecimal.ROUND_DOWN));
